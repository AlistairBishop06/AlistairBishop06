...
<img
  src="https://komarev.com/ghpvc/?username=AlistairBishop06&style=flat-square&color=58a6ff&label=Profile+views"
  alt="Profile views"
/>
...
<img
  src="https://skillicons.dev/icons?i=python,cs,java,kotlin,js,ts,html,css,ruby,dotnet,django,nextjs,threejs,mysql,sqlite,git,github,githubactions,unity,azure,vercel,vscode,visualstudio&perline=12"
...
<details open>
<summary><strong>Recent development activity</strong></summary>

<br>

<!--RECENT_ACTIVITY:start-->
1. ⭐ Starred [Nieko27/Frame-Workshop](https://github.com/Nieko27/Frame-Workshop)<br>
2. ⭐ Starred [HLANoVR/HLA-NoVR](https://github.com/HLANoVR/HLA-NoVR)<br>
3. ⭐ Starred [AlistairBishop06/Chaos-Chess](https://github.com/AlistairBishop06/Chaos-Chess)<br>
4. ⬆️ Pushed undefined commit(s) to [AlistairBishop06/Python-Cloth-Sim](https://github.com/AlistairBishop06/Python-Cloth-Sim)<br>
